    ...
    <Footer container className="border border-t-8 border-teal-500">
      <div className="w-full max-w-7xl mx-auto:">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            <div>
              <div>
                ...
                <Footer.LinkGroup col>
                  <Footer.Link
                    href="https://www.ashishshrivastav.com"
                    target="_blank"
            ...
            <div>
              <div>
                ...
                <Footer.LinkGroup col>
                  <Footer.Link
                    href="https://github.com/shrivastavashish"
                    target="_blank"
                    rel='noopener noreferrer'
                  >
                    Github
                  ...
                  <Footer.Link
                    href="https://www.linkedin.com/in/shrivastav/"
                    target="_blank"
                    rel='noopener noreferrer'
                  >
                    Linkedin
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between">
            <Footer.Copyright href="#" by="Ashish Shrivastav" year={new Date().getFullYear()}/>
